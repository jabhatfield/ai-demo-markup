...
- ML chatbot for enquires about a zoo, based on https://opennlp.apache.org[Apache OpenNLP,window=_blank]
*Natural Language Processing* (*NLP*)
- DL image recognition of handwriting, based on https://djl.ai[Deep Java Library,window=_blank] (*DJL*)
