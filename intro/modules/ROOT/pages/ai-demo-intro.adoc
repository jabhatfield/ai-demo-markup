...
* xref:zoo-chatbot-component::zoo-chatbot-intro.adoc[ML chatbot] for enquires about a zoo, based on https://opennlp.apache.org[Apache OpenNLP,window=_blank]
*Natural Language Processing* (*NLP*)
* xref:handwriting-recogniser-component::handwriting-recogniser-intro.adoc[DL image recognition] of handwriting, based on https://djl.ai[Deep Java Library,window=_blank] (*DJL*)
